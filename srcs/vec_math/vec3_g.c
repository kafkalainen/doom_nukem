...
/*   Updated: 2021/08/04 15:57:16 by jnivala          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
**	Point of intersection is then the direction * barycentric coordinate multiplier.
**	We test the sidedness of new triangle, and calculate it's vectors along the edges,
**	if any point lies outside any of it's edges, then we return false.
*/
Uint32	vec3_ray_triangle_intersect(t_triangle *tri, t_xyz pos, t_xyz dir,
		t_xyz *isection)
{
	float	dot;
	t_plane	plane;
